      ...
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        >
          ...
          <p className="mb-8 leading-relaxed text-lg text-gray-400 max-w-xl">
            Elevate your interview skills with AI-powered simulations, real-time
            feedback, and immersive practice rounds. Step into your future with
            confidence.
          </p>
        </div>
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20">
            ...
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-400 text-opacity-90">
              Your one-stop platform for mastering technical, HR, and mock
              interviews with AI-powered tools and expert insights.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            <p className="text-gray-400 text-lg mb-6">
              Step into a full day-in-the-life virtual tech office. Powered by
              GenAI, avatars, STT and TTS, this simulation mimics real job
              workflows — from standups and manager check-ins to fun hours and
              peer chats.
              <br />
              <br />
              With CultureMatch AI and dynamic coding challenges, recruiters
              evaluate real-time behavior, communication, and decision-making —
              not just resumes. Perfect for students & professionals to
              showcase how they actually work.
            </p>
            <button
