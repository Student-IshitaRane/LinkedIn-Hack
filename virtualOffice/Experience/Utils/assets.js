        ...
        westgate: {
            assets: [
                ...
                },
                {
                    name: "a",
                    type: "glbModel",
                    path: "/models/avatars/avatar1.glb",
                },
                {
                    name: "b",
                    type: "glbModel",
                    path: "/models/avatars/avatar2.glb",
                },
                {
                    name: "c",
                    type: "glbModel",
                    path: "/models/avatars/avatar3.glb",
                },
                {
                    name: "d",
                    type: "glbModel",
                    path: "/models/avatars/avatar4.glb",
                },
                {
                    name: "e",
                    type: "glbModel",
                    path: "/models/avatars/avatar5.glb",
                },
                {
                    name: "f",
                    type: "glbModel",
                    path: "/models/avatars/avatar6.glb",
                },
                {
                    name: "bars",
                    type: "glbModel",
